  ...
  return (
    <div style={s.page}><div style={s.card}>
      <div style={{ textAlign: "center", marginBottom: 28 }}>
        ...
        <h1 style={{ fontSize: 22, fontWeight: 800, color: "var(--text-strong)", marginBottom: 4 }}>加入 Pro-OW</h1>
        <p style={{ fontSize: 13, color: "var(--text-muted)" }}>创建你的账号</p>
      </div>
      ...
      <p style={{ textAlign: "center", marginTop: 20, fontSize: 13, color: "var(--text-muted)" }}>已有账号？<Link to="/login" style={{ color: "var(--ow-orange)", textDecoration: "none", fontWeight: 600 }}>立即登录</Link></p>
    </div></div>
  );
}
